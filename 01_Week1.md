...
Instructor copy: `instructor_private/markdown_mash/Week1_Quiz.md`. This path is intentionally ignored by git so learners do not see the questions or answer key ahead of time.
